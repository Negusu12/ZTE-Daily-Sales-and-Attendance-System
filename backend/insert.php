...
if (isset($_POST['submit'])) {
    ...
    $V50_Design_available = addslashes($_POST['V50_Design_available']);
    $V50_Design_sold = addslashes($_POST['V50_Design_sold']);
    $V50_Design_left = addslashes($_POST['V50_Design_left']);
    $A54_available = addslashes($_POST['A54_available']);
    $A54_sold = addslashes($_POST['A54_sold']);
    $A54_left = addslashes($_POST['A54_left']);
    $V40_available = addslashes($_POST['V40_available']);
    $V40_sold = addslashes($_POST['V40_sold']);
    $V40_left = addslashes($_POST['V40_left']);
    $remark = addslashes($_POST['remark']);

    $sql = "INSERT INTO `daily_sales`(`promoter_name`, `promoter_phone`, `shop`, `a33_core_available`, `a31_lite_available`, `a31_lite_sold`, `blade_a31_available`, `blade_a51_available`, `blade_a71_available`, `blade_v30_available`, `mf971L_available`, `mf286c_available`, `a33_core_sold`, `blade_a31_sold`, `blade_a51_sold`, `blade_a71_sold`, `blade_v30_sold`, `mf971L_sold`, `mf286c_sold`, `a33_core_left`, `a31_lite_left`, `blade_a31_left`, `blade_a51_left`, `blade_a71_left`, `blade_v30_left`, `mf971L_left`, `mf286c_left`, `V50_Design_available`, `V50_Design_sold`, `V50_Design_left`, `A54_available`, `A54_sold`, `A54_left`, `V40_available`, `V40_sold`, `V40_left`, `remark`) VALUES ('$promoter_name', '$promoter_phone', '$shop', '$a33_core_available', '$a31_lite_available', '$a31_lite_sold', '$blade_a31_available', '$blade_a51_available', '$blade_a71_available', '$blade_v30_available', '$mf971L_available', '$mf286c_available', '$a33_core_sold', '$blade_a31_sold', '$blade_a51_sold', '$blade_a71_sold', '$blade_v30_sold', '$mf971L_sold', '$mf286c_sold', '$a33_core_left', '$a31_lite_left', '$blade_a31_left', '$blade_a51_left', '$blade_a71_left', '$blade_v30_left', '$mf971L_left', '$mf286c_left', '$V50_Design_available', '$V50_Design_sold', '$V50_Design_left', '$A54_available', '$A54_sold', '$A54_left', '$V40_available', '$V40_sold', '$V40_left', '$remark')";
