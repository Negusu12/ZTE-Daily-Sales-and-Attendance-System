    ...
    <script>
        $(document).ready(function() {
            ...
            table.columns().every(function() {
                ...
                if (columnTitle === 'Date') {
                    var input = $('<input type="text" class="form-control date-range" placeholder="Select date range"/>')
                    ...
                    flatpickr(input[0], {
                        ...
                        onClose: function(selectedDates) {
                            var fromDate = selectedDates[0] ? formatDate(selectedDates[0]) : '';
                            var toDate = selectedDates[1] ? formatDate(selectedDates[1]) : '';
                            that.search(fromDate + '|' + toDate).draw();
                        }
                    });
                } else {
